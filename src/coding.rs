...
impl<'a> Parser<'a> {
    ...
    ///
    ///     use qrqrpar::coding::{Parser, Segment};
    ///     use qrqrpar::types::Mode::{Alphanumeric, Numeric, Byte};
    ///
...
#[cfg(test)]
mod parse_tests {
    use crate::coding::{Parser, Segment};
...
#[cfg(test)]
mod optimize_tests {
    use crate::coding::{total_encoded_len, Optimizer, Segment};
    use crate::types::{Mode, Version};
